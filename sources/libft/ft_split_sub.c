...
/*   Updated: 2024/05/19 11:04:50 by lopoka           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "libft.h"
...
static inline int	ft_count_words(const char *s, char sep, int esc)
{
	int		count;
	t_token	token;
...
char	**ft_split_sub(const char *str, char sep, int esc)
{
	char	**res;
	int		words;
	t_token	token;
	...
	words = ft_count_words(str, sep, esc);
